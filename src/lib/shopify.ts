...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = "sweet-creations-hub-3tcl4-emuk4ghy.myshopify.com";
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = "b3f180187721fc20ed15511e802c3395";
...
export async function getShopifyCart(cartId: string): Promise<{ id: string; totalQuantity: number } | null> {
